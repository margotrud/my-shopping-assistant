...
class TestExtractFromAdjacent(unittest.TestCase):
    ...
    def test_case_11(self): self.run_case("peachy pink", {"peach pink"})
    ...
    def test_case_28(self): self.run_case("intense sky blue", {"intense sky"})
    def test_case_29(self): self.run_case("blue soft", set())
    def test_case_30(self): self.run_case("deep deep rose", {"deep rose"})
    def test_case_31(self): self.run_case("green mint", set())
    ...
    def test_case_44(self): self.run_case("midnight blue",set())
    def test_case_45(self): self.run_case("airy lilac", {"fair lilac"})
    def test_case_46(self): self.run_case("dusky teal",  {"dust teal"})
    def test_case_47(self): self.run_case("barely there pink", {"barely-there pink"})  # only if "barely" is modifier
