...
class TestExtractCompoundPhrases(unittest.TestCase):
    ...
    def test_case_26(self): self.run_case("dark pink blush", {"pinky blush", "dark pink"})
    def test_case_27(self): self.run_case("soft-glow", set())
    def test_case_28(self): self.run_case("offwhite", {'off-white white'})
    ...
    def test_case_47(self): self.run_case("warm beige peach", {"warm beige", "beigey peach"})
