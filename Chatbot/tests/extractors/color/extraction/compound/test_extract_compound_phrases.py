...
class TestExtractCompoundPhrases(unittest.TestCase):
    ...
    def test_case_08(self): self.run_case("glowy bronze", {"glowy bronze"})
    ...
    def test_case_14(self): self.run_case("taupeybeige", {"taupey beige"})
    def test_case_15(self): self.run_case("babyblue", {"baby blue"})
    def test_case_16(self): self.run_case("cool tone", set())
    def test_case_17(self): self.run_case("mochish blush", {"mochish blush"})
    def test_case_18(self): self.run_case("elegant blush", set())
    def test_case_19(self): self.run_case("darknight", {"dark night"})
    def test_case_20(self): self.run_case("glamorousred", {"glamorous red"})
    ...
    def test_case_24(self): self.run_case("rosybrown", {"rosy brown"})
    def test_case_25(self): self.run_case("intensecranberry", {"intense cranberry"})
    def test_case_26(self): self.run_case("dark pink blush", {"dark pink", "pink blush"})
    def test_case_27(self): self.run_case("soft-glow", {"soft glow"})
    def test_case_28(self): self.run_case("offwhite", {"off white"})
    ...
    def test_case_34(self): self.run_case("darkpeachy", {"dark peachy"})
    ...
    def test_case_37(self): self.run_case("inky blue", {"inky blue"})
    ...
    def test_case_41(self): self.run_case("mossygreen", {"mossy green"})
    ...
    def test_case_46(self): self.run_case("rustyred", {"rusty red"})
    ...
    def test_case_50(self): self.run_case("earthy pinky", {"earthy pinky"})
