...
class TestAttemptModTonePair(unittest.TestCase):
    ...
    def test_case_25(self): self.run_case("inky", "black", None)
    ...
    def test_case_42(self): self.run_case("inky", "blue", None)
    ...
    def test_case_48(self): self.run_case("light", "goldish", None)
    def test_case_49(self): self.run_case("clear", "mint", None)
