...
class TestExtractFromGlued(unittest.TestCase):
    ...
    def test_case_08(self): self.run_case("moodytaupe", {"moody taupe"})
    ...
    def test_case_31(self): self.run_case("mistymauve", {"misty mauve"})
    ...
    def test_case_40(self): self.run_case("lilacyrose", {"lilacy rose"})
    def test_case_41(self): self.run_case("beigeygold", {"beigey gold"})
    def test_case_42(self): self.run_case("navyplum", {"navy plum"})
    def test_case_43(self): self.run_case("smokygraphite", {"smoky graphite"})
    def test_case_44(self): self.run_case("earthyterracotta", {"earthy terracotta"})
    ...
    def test_case_49(self): self.run_case("nuttyrose", {"nutty rose"})
