...
class TestResolveModifierToken(unittest.TestCase):
    ...
    def test_case_14(self): self.run_case("pink", "pink")
    def test_case_15(self): self.run_case("pinky", "pinky")
    def test_case_16(self): self.run_case("pnk", "pinky")
    ...
    def test_case_39(self): self.run_case("dst", "dust")
    ...
    def test_case_47(self): self.run_case("bld", "bold")
