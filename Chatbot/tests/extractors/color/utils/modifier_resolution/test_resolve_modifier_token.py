...
class TestResolveModifierToken(unittest.TestCase):
    ...
    def test_case_04(self): self.run_case("red", None, is_tone=False)
    ...
    def test_case_10(self): self.run_case("blue", None, is_tone=False)
    def test_case_11(self): self.run_case("cool", "cool")
    def test_case_12(self): self.run_case("cooly", "cool")
    def test_case_13(self): self.run_case("clr", None)
    def test_case_14(self): self.run_case("pink", None)
    ...
    def test_case_20(self): self.run_case("green", None, is_tone=False)
    def test_case_21(self): self.run_case("glowy", "glowy")
    def test_case_22(self): self.run_case("glowyish", "glowy")
    def test_case_23(self): self.run_case("glw", "glowy")
    def test_case_24(self): self.run_case("orange", None, is_tone=False)
    ...
    def test_case_28(self): self.run_case("yellow", None, is_tone=False)
    ...
    def test_case_32(self): self.run_case("black", None, is_tone=False)
    ...
    def test_case_36(self): self.run_case("white", None, is_tone=False)
    ...
    def test_case_47(self): self.run_case("bld", None)
