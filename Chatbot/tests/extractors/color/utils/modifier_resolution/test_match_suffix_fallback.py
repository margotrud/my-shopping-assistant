...
class TestMatchSuffixFallback(unittest.TestCase):
    ...
    def test_case_16(self): self.run_case("earthy", "earth")
    def test_case_17(self): self.run_case("creamy", "cream")
    def test_case_18(self): self.run_case("rosy-", "rose")  # trailing hyphen stripped
    def test_case_19(self): self.run_case("dusty ", "dust")  # trailing space stripped
    ...
    def test_case_31(self): self.run_case("softyy", "soft")       # endswith "y" but base "softy" not in modifiers
    ...
    def test_case_34(self): self.run_case("smokeyy", "smoke")
    def test_case_35(self): self.run_case("brighty-", "bright")
    def test_case_36(self): self.run_case("mutedish", "muted")
    def test_case_37(self): self.run_case("light-", "light")
    def test_case_38(self): self.run_case("", None)              # empty string
    def test_case_39(self): self.run_case(" ", None)             # space only
    def test_case_40(self): self.run_case("softishy", "soft")      # suffix inside word
    def test_case_41(self): self.run_case("coolish-", "cool")
    def test_case_42(self): self.run_case("coldy", None)         # base "cold" not in modifiers (assuming)
    def test_case_43(self): self.run_case("dustyy", "dust")
    def test_case_44(self): self.run_case("dustyishy", "dust")
    def test_case_45(self): self.run_case("dustyish-", "dust")
    def test_case_46(self): self.run_case("fasty", None)
    def test_case_47(self): self.run_case("dust", "dust")           # no suffix, should return None
    def test_case_48(self): self.run_case("pink", None)
    def test_case_49(self): self.run_case("redish", None)        # base "red" not in modifiers
    def test_case_50(self): self.run_case("softishish", "soft")
