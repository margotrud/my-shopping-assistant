...
class TestGetGluedTokenVocabulary(unittest.TestCase):
    ...
    def test_case_03(self): self.assertTrue("light pink" in get_glued_token_vocabulary())
    ...
    def test_case_06(self): self.assertTrue("deep pink" in get_glued_token_vocabulary())
    ...
    def test_case_15(self): self.assertTrue("blue green" in get_glued_token_vocabulary())
    ...
    def test_case_18(self): self.assertTrue("soft pink" in get_glued_token_vocabulary())
    ...
    def test_case_22(self): self.assertFalse(all(" " not in t for t in get_glued_token_vocabulary()))
