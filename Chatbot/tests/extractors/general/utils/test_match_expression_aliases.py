...
class TestMatchExpressionAliases(unittest.TestCase):
    ...
    def test_case_14(self): self.run_case("natural", ["natural"])
    def test_case_15(self): self.run_case("no makeup", ["daytime"])
    ...
    def test_case_22(self): self.run_case("glowy", [])
    ...
    def test_case_25(self): self.run_case("clean and classy", ["natural"])
    ...
    def test_case_33(self): self.run_case("no makeup", ["daytime"])
    def test_case_34(self): self.run_case("nomakeup", ["daytime"])
    ...
    def test_case_38(self): self.run_case("edgy sparkle", ["edgy"])
    def test_case_39(self): self.run_case("barely there", ["natural"])
    ...
    def test_case_45(self): self.run_case("barely there glam", ["natural", "soft glam"])
    def test_case_46(self): self.run_case("minimal makeup", ["natural"])
    def test_case_47(self): self.run_case("minmal", [])
    def test_case_48(self): self.run_case("vibrnt", [])
