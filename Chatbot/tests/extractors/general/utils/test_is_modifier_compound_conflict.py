...
import unittest
from Chatbot.extractors.color.utils.modifier_resolution import is_modifier_compound_conflict
...
class TestIsModifierCompoundConflict(unittest.TestCase):
    ...
    def test_case_06(self): self.run_case("dewy", True)
    ...
    def test_case_16(self): self.run_case("nude", True)
    ...
    def test_case_22(self): self.run_case("fresh", True)
    ...
    def test_case_37(self): self.run_case("sparkle", True)
    def test_case_38(self): self.run_case("luminous", True)
    def test_case_39(self): self.run_case("moist", True)
    def test_case_40(self): self.run_case("ultra-deep", True)

    def test_case_41(self): self.run_case("intense", True)
    def test_case_42(self): self.run_case("milky", True)
    ...
    def test_case_47(self): self.run_case("creme", True)
    def test_case_48(self): self.run_case("tinted", False)
    def test_case_49(self): self.run_case("naked", False)
    def test_case_50(self): self.run_case("boldness", True)
