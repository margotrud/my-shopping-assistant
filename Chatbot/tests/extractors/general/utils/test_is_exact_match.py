...
class TestIsExactMatch(unittest.TestCase):
    ...
    def test_case_22(self): self.run_case("lavender blush", "lavender-blush", True)
    def test_case_23(self): self.run_case("lavender", "lavender blush", False)
    def test_case_24(self): self.run_case("glowy", "glowy", True)
    def test_case_25(self): self.run_case("glowy✨", "glowy", True)

    def test_case_26(self): self.run_case("off white", "offwhite", True)
    def test_case_27(self): self.run_case("offwhite", "off white", True)
    def test_case_28(self): self.run_case("bare skin", "bareskin", True)
    def test_case_29(self): self.run_case("bareskin", "bare skin", True)
    def test_case_30(self): self.run_case("bold look", "bold look", True)

    def test_case_31(self): self.run_case("bold look", "boldlook", True)
    def test_case_32(self): self.run_case("soft glam", "softglam", True)
    def test_case_33(self): self.run_case(" glam", "glam", True)
    def test_case_34(self): self.run_case("Glam", "glam", True)
    def test_case_35(self): self.run_case("Glam!", "glam", True)

    def test_case_36(self): self.run_case("red carpet", "redcarpet", True)
    ...
    def test_case_41(self): self.run_case("glamourous", "glamorous", True)
    def test_case_42(self): self.run_case("no makeup", "nomakeup", True)
    def test_case_43(self): self.run_case("nomakeup", "no makeup", True)
    def test_case_44(self): self.run_case("clean girl", "clean girl", True)
    def test_case_45(self): self.run_case("clean girl", "cleangirl", True)

    def test_case_46(self): self.run_case("  valentine ", "valentine", True)
    def test_case_47(self): self.run_case("valentine", "valentine", True)
    def test_case_48(self): self.run_case("valentines", "valentine", True)
    def test_case_49(self): self.run_case("red carpet", "red carpets", True)
